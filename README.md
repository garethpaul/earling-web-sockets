...
When Erlang/OTP is installed, the baseline gate runs `make test`. In
documentation-only environments without `erl`/`escript`, it performs static
guard checks and reports that the rebar tests were skipped.
