---
title: HTMLFile POST Authorization Order
type: security
date: 2026-06-14
status: completed
execution: code
...
# HTMLFile POST Authorization Order

## Summary

Authorize `htmlfile` POST request origins before parsing or decoding their
...
- R2. Parse and decode HTMLFile POST data only in the allowed or absent-Origin
...
- Added shared Origin verification before the HTMLFile POST body path.
